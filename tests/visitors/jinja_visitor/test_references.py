    ...
    node = ReferencesNode(
        ...
        entries=[
            ReferencesEntryNode(
                ...
                number=1,
                title=SentenceNode(children=[TextNode("Some title 1.1")]),
            ...
            ReferencesEntryNode(
                ...
                number=2,
                title=SentenceNode(children=[TextNode("Some title 1.2")]),
            ...
            ReferencesEntryNode(
                ...
                number=3,
                title=SentenceNode(children=[TextNode("Some title 2.1")]),
